...
export default function Home() {
  ...
  const handleSaveSelectedCoords = (color: string) => {
    ...
    const selectedIdx = coords.findIndex(
    ...
    if (selectedIdx > -1) {
      ...
      $place.setSelectedCoords([
        ...
        {
          coord: {
            lat: $place.currentMapCenter.lat,
            lng: $place.currentMapCenter.lng,
          },
          color: color,
        },
      ]);
    ...
    <>
      <div className="w-full h-screen relative">
        ...
        <Button
          ...
          onClick={() => {
            setOpenCoordButtons(!openCoordButtons);
          }}
        >
          <i className="material-symbols-outlined">
        ...
        <div
          className={`fixed z-[9] overflow-hidden ${
            openCoordButtons ? "left-16 w-full" : "left-5 w-1"
          } bottom-5 flex gap-1 duration-300`}
        >
