...
export default function RootLayout({
  ...
  const GOOGLE_MAP_API_KEY = `https://maps.googleapis.com/maps/api/js?key=${process.env.NEXT_PUBLIC_GOOGLE_MAP_API_KEY}&libraries=maps,marker,places&v=beta`;
  ...
  return (
    <html lang="ko" className=" h-full">
      ...
      <body className="text-black bg-[#222] h-full">{children}</body>
    </html>
  );
}
